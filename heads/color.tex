%%%  README:
%%%  Wie Farben in diesem Dokument funktionieren:
%%% Es werden Farben mit \def\colorname{DEZ} die Farben definiert. 
%%% Da die Farben öfter an verschiedenen Stellen im Text genutzt werden,
%%% werden die Farben nach dem Definieren auf Entsprechende Namen gemappt
%%% Dadurch hat man eine Anzahl von Farben und dann mehrere gemappte Farben.
%%% Es werden nur die gemappten in Dokumenten genutzt. 

%%% Farben die definiert wurden und damit gemappt werden können:
%%% Primary Color:
%%%
%%% Farbe1 blue
...
%%%  Ab hier werden die Farben entsprechend dem Anwendungsort gemappt
%%% Hier wurde als Prefix das Wort 'moo' genutzt. Damit z.b. emphasize nicht mit echten Befehlen den gleichen Namen haben 
%%% Moo wurde genutzt da ich vor der Erstellung cowsay genutzt habe. 
